import { w as slot, x as bind_props, y as attr_class } from './index-C38Lqc8r.js';
import { G as fallback } from './context-DWf2YUHq.js';
import { p as page } from './index2-D1UvyWoY.js';
...
function BackToTop($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let hidden = true;
    $$renderer2.push(`<button${attr_class("back-to-top svelte-xb6ku1", void 0, { "hidden": hidden })} aria-label="none"></button>`);
...
//# sourceMappingURL=_layout.svelte-GG70e2ox.js.map
