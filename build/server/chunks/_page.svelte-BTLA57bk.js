...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("6l2x5i", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>erecht24 API v2 Test Project</title>`);
      });
      $$renderer3.push(`<meta name="description" content="imprint in english from erecht24 API v2 test project"/>`);
    });
...
//# sourceMappingURL=_page.svelte-BTLA57bk.js.map
