...
import './context-DWf2YUHq.js';

function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    const target = "_blank";
    const rel = "noopener noreferrer";
    head("1wrxkfy", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>erecht24 API v2 Test Project</title>`);
      });
      $$renderer3.push(`<meta name="description" content="imprint in german from erecht24 API v2 test project"/>`);
    });
...
//# sourceMappingURL=_page.svelte-Bj2_bSPs.js.map
