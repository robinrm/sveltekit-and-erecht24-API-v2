...
import { a as html_en, l as logo, m as modified } from './seal_copyright-BqFX8j1O.js';
...
function _page($$payload, $$props) {
  ...
  if (data.error == void 0) {
    ...
    let json_input = JSON.stringify(html_en, null, 4);
    json_input = json_input.replace(/\r?\n|\r/g, "");
    apidata_content = JSON.parse(json_input);
    display_api_data = true;
...
//# sourceMappingURL=_page.svelte-C_ZFMCaG.js.map
